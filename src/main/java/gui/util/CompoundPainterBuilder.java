...
import application.routing.RoutingApplication2;
...
public class CompoundPainterBuilder {
     ...
     * @return The current object.
     */
    public CompoundPainterBuilder withRoutingPath(Environment environment, RoutingApplicationNew routingApplication) {
