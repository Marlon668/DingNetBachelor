 ...
 */
public class Airquality extends GenericFeedbackLoop {
    /**
     * A HashMap representing the buffers for the approach.
     */
    @Model
    private Map<Mote, List<Double>> airQualityBuffers;
    ...
    private void putReliableMinPowerBuffer(Mote mote, List<Double> reliableMinPowerBuffer) {
        this.airQualityBuffers.put(mote, reliableMinPowerBuffer);
    }
